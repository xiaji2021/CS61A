...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    if opponent_score < 10 or player_score == 0 or opponent_score == 0: return False
...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    if opponent_score - player_score in range(1,3): return True
    else: return False
    "*** YOUR CODE HERE ***"
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        while who and score0 < goal and score1 < goal and extra_turn(score1, score0):
            score1 += take_turn(strategy1(score1,score0), score0, dice)
            say = say(score0,score1)
        while 1-who and score0 < goal and score1 < goal and extra_turn(score0, score1):
            score0 += take_turn(strategy0(score0,score1), score1, dice)
            say = say(score0,score1)
        who = other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who and score1-last_score > current_high:
            current_high = score1 - last_score
            print(current_high, 'point(s)! The most yet for Player 1')
            

        elif 1 - who and score0 - last_score > current_high:
            current_high = score0 - last_score
            print(current_high, 'point(s)! The most yet for Player 0')
            # return announce_highest(who, score0, current_high)

        return announce_highest(who, score1, current_high) if who else announce_highest(who, score0, current_high)
    return say
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    average_max = make_averaged(roll_dice, trials_count)
    max = 0
    for i in range(10, 0, -1):
           if max < average_max(i, dice):
               max =  average_max(i, dice)
               max_i = i
    return max_i
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score,opponent_score, 8, 3)
